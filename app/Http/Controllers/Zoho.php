...
//     ->level(Levels::INFO)
//     ->filePath("D:\\OpenServer\\home\\zohotest\\users\\php_sdk_log.log")
//     ->build();

//     $environment = EUDataCenter::DEVELOPER();// PRODUCTION();
//     // dd("aaa", $environment);
...
//         // ->findUser(true) // by default true
//         ->build();

//     $tokenstore = new FileStore("D:\\OpenServer\\home\\zohotest\\tokenstore\\tokenstore.txt");
...
//     $resourcePath = "D:\\OpenServer\\home\\zohotest\\users\\res";
